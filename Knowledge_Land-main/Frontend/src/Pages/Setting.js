...
function Setting() {
    ...
    const getStuData = () => {
        axios.get(baseUrl + "addstudents").then((res) => setStuList(res.data.data.filter((i) => i.type === "student" )))
    }
    const getTeachData = () => {
        axios.get(baseUrl + "addstudents").then((res) => setTeachList(res.data.data.filter((i) => i.type === "teacher" )))
    }
